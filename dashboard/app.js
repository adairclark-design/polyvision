...
function renderDiscordLinkButton() {
  ...
  container.innerHTML = state.discordLinked
    ? `<a class="discord-linked" href="https://discord.gg/tUUUcFJX6p" target="_blank" rel="noopener" title="Open the PolyVision Discord server">💙 Discord Linked ✅ — Join Server</a>`
